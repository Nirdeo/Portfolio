...
<div class="container admin">
    ...
    <div class="accordion" id="accordionProjet">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseFive" class="accordion-collapse collapse hide" aria-labelledby="headingFive"
                 data-bs-parent="#accordionProjet">
                <div class="accordion-body">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseSix" class="accordion-collapse collapse hide" aria-labelledby="headingSix"
                 data-bs-parent="#accordionProjet">
                <div class="accordion-body">
                    <strong><?php
                        $co = connexionBdd();
